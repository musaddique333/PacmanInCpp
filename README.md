<h1 align="center">
  <br>
  <a href=""><img src="https://i.pinimg.com/originals/b4/ee/c4/b4eec4d093adbe9d8a3cbb40d024836a.png" width="250"></a>
  <br>
  <br>
</h1>
...
<div align="center">
  <img src="https://res.cloudinary.com/dek4evg4t/image/upload/v1562267184/ezgif.com-video-to-gif_1.gif" alt="centered gif">
</div>
...
1. On GitHub, go to the main page of the [repository](https://github.com/musaddique333/PacmanInCpp).
...
6. Type 'git clone', and then paste the URL that you copied in Step 2.
   ...
   ```$ git clone https://github.com/musaddique333/PacmanInCpp```
   
7. Press Enter. Your local clone will be created for [pacman](https://github.com/musaddique333/PacmanInCpp).
...
## Authors
* **Mohammed Musaddique** - *developer and ux designer* - [musaddique333](https://github.com/musaddique333)

## License
This project is licensed under the GNU General Public License v3.0 - see the [LICENSE.md](https://github.com/musaddique333/PacmanInCpp/blob/master/LICENSE) file for details
